  ...
  return (
    <div className="home">
      ...
      <p>
        ...
        feugiat urna. Nunc efficitur vel ex non vehicula. Donec finibus nunc id
        erat eleifend auctor.
      </p>
      <p>
        Suspendisse hendrerit eleifend turpis, at ultrices nulla vehicula in.
        Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere
        cubilia curae; Curabitur vel rutrum purus. In hendrerit velit lorem, eu
        scelerisque ipsum lobortis vel. Vivamus a felis aliquet, elementum est
        eget, finibus risus.
      </p>
    </div>
  );
